...
describe('SignUpFormComponent', () => {
  let component: WarehouseAssistantSignUpComponent;
  let fixture: ComponentFixture<WarehouseAssistantSignUpComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [ WarehouseAssistantSignUpComponent, InputFieldComponent ],
    ...
    fixture = TestBed.createComponent(WarehouseAssistantSignUpComponent);
